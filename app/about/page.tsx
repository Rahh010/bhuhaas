...
export default function AboutPage() {
    return (
        ...
        <div className='justify-center items-start flex flex-col p-5 pt-[100px]'>
            ...
            <p className='mt-4' data-aos="fade-up">At Bhuhaas, we are dedicated to providing top-notch digital marketing solutions that help businesses thrive in the online world. Our team of experts specializes in SEO, social media management, content creation, and more, ensuring that your brand reaches its full potential.</p>
            <p className='mt-4'data-aos="fade-up">Founded in 2024, Bhuhaas has quickly established itself as a trusted partner for businesses looking to enhance their digital presence. We pride ourselves on our innovative strategies, personalized approach, and commitment to delivering measurable results for our clients.</p>
            <p className='mt-4' data-aos="fade-up">Our mission is to empower businesses of all sizes to succeed in the digital landscape through effective marketing strategies and cutting-edge technology. We believe in building long-term relationships with our clients, based on trust, transparency, and mutual success.</p>
        </div>
              {/* Get in Touch */}
